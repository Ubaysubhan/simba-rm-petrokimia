	 ...
	 mx-0  px-4 md:mx-12">
		<div class="flex justify-between">
			...
			<div class="hidden md:flex items-center space-x-3 ">
					...
					<div>
						<span class="rounded-md shadow-sm">
							<button id="dropdown-button" type="button"
								class="py-2 px-2 flex font-medium text-gray-500 rounded hover:bg-yellow-400 hover:text-white transition duration-300">
				...
				<a href="/login"
					class="py-3 my-4 px-2 flex font-medium text-gray-500 rounded hover:bg-yellow-400 hover:text-white transition duration-300"><svg
