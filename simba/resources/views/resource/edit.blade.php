...
<form method="POST" action="/edit" class="pt-4 max-w-4xl mx-auto my-5" enctype="multipart/form-data">
    @csrf
    <!-- {{ csrf_field() }} -->
    {{--
    <div> @if($errors->any())
        ...
        @endif
        <div> --}}
            <h1 class="text-2xl leading-6 font-medium text-gray-900">Edit Barang</h1>
        ...
        <div class="space-y-6 pt-10 sm:space-y-5">
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                ...
                <div class="relative">
                    ...
                    <input datepicker name="date" type="text" value="{{old('date',$value->tanggal)}}"
                ...
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <input type="text" name="requester" id="first-name" autocomplete="given-name"
                            value="{{old('requester',$value->requester)}}"
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <input type="text" name="deskripsi" id="first-name" autocomplete="given-name"
                                value="{{old('deskripsi',$value->deskripsi)}}"
                                class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md">
                        </div>
                    </div>

                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center sm:border-t sm:border-gray-200 sm:pt-5">
                        <label for="foto" name="foto" class="block text-sm font-medium text-gray-700"> Foto Lama
                        </label>
                        <img class="" src="{{ url('dist/'. $value->foto) }}" style="height: 100px; width: 100px;">
                    </div>
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center sm:border-t sm:border-gray-200 sm:pt-5">
                        <label for="foto" name="foto" class="block text-sm font-medium text-gray-700"> Foto Baru
                        </label>
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <div class="bg-white p7 rounded w-9/12 ">
                                <div x-data="dataFileDnD()"
                                    ...
                                    <div x-ref="dnd"
                                        ...
                                        <input accept="*" type="file" name="foto" value="{{old('foto',$value->foto)}}"
                                            multiple
                        ...
                        <div class="flex space-between justify-end">
                            ...
                            <div class="pt-5 form-group">
                                <div class="flex justify-end">
                                    <button type="submit" value="{{$value->id}}" name="id_barang"
